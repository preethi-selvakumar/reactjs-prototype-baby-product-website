...
import MomsProductListing from '../components/MomsProductListing';
...
const MomsBabyCare = () => {
    ...
    return (
        <div className="moms-baby-care-page">
            ...
            <div className="container-fluid py-4">
                <div className="row">
                    ...
                    <div className="col-lg-9 col-md-8">
                        {/* Passing filterState to the Moms specific Listing component */}
                        <MomsProductListing
                            filterState={filterState}
                        />
                    </div>
