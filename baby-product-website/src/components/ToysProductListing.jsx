...
const ToysProductListing = ({ filterState }) => {
    ...
    const sortedProducts = useMemo(() => {
        ...
        let filteredList = products.filter(product => {
            ...
            // gender filter (updated logic for toys)
            if (gender) {
                const hasBoyKeywords = ['bike', 'slide', 'dino'];
                const hasGirlKeywords = ['kitchen', 'piano', 'pink'];

                if (gender === 'Boy' && hasGirlKeywords.some(keyword => productName.includes(keyword))) {
                    return false;
                }
                if (gender === 'Girl' && hasBoyKeywords.some(keyword => productName.includes(keyword))) {
                    return false;
                }
            }
        ...
        <div className="product-listing-area">
            ...
            <div className="row align-items-center mb-4 product-listing-header">
                ...
                <div className="col-auto">
                    <h1 className="product-listing-heading m-0">Toys</h1>
                </div>
...
export default ToysProductListing;
