...
import FootwearProductListing from '../components/FootwearProductListing';
            ...
            <div className="container-fluid py-4">
                <div className="row">
                    ...
                    <div className="col-lg-9 col-md-8">
                        {/* Passing filterState to the Footwear specific Listing component */}
                        <FootwearProductListing
                            filterState={filterState}
                        />
                    </div>
                </div>
