...
import products from '../data/babyFashionData';
import { FaAngleDown, FaAngleUp } from 'react-icons/fa';

const BabyProductListing = ({ filterState }) => {
    ...
    const sortedProducts = useMemo(() => {
        ...
        let filteredList = products.filter(product => {
            ...
            // gender filter (dummy check based on name)
            if (gender) {
                if (gender === 'Boy' && !productName.includes('boy') && !productName.includes('junior')) return false;
                if (gender === 'Girl' && !productName.includes('girl') && !productName.includes('frock')) return false;
            }

            // brands filter (dummy check based on name)
            if (brands.length > 0) {
            ...
            if (collection) {
                ...
                if (collection === 'Extra warm' && !productName.includes('warm')) return false;
            }
        ...
        <div className="product-listing-area">
            ...
            <div className="row align-items-center mb-4 product-listing-header">
                ...
                <div className="col-auto">
                    <h1 className="product-listing-heading m-0">Baby Fashions</h1>
                </div>
...
export default BabyProductListing;
